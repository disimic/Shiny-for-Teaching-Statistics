...
renderPrint(cat(paste("And the result is:", input$Flag)))
```
...
renderPrint(cat(paste("And the result is:", input$Select)))
```
...
renderPrint(cat(paste("And the result is:", input$rad.id)))
```
...
renderPrint(cat(paste("And the result is:", input$Number)))
```
...
renderPrint(cat(paste("And the result is:", input$Slide1)))
```
...
renderPrint(cat(paste("And the result is:", paste(input$Slide2, collapse = " to "))))
```
